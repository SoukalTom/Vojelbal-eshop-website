...
<html lang="cs">
    ...
    <head>
        <title> Produkty | Volejbal centrum Lužiny </title>
    ...
    <body>
        <header>
            ...
            <!-- <script>
                $(function() {
                    $('.sc-content-paste').load("../shopping-cart-content.html");
                });
            </script> -->
        </header>
        
        <main>
            <h1 class="products-heading"> Produkty - Příšlušenství k míčům </h1>
            <div class="products-main-container">
                ...
                <div class="products-list-container">
                    ...
                    include '../php/ball-accessories-select.php';
                    ?>
